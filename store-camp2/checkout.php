                            ...
                            <div id="optional-extras">
								...
								if ($results = $db->get_results($query)) {
									foreach ($results as $result) {
										$campaign_list.='
<li>
<input type="radio" id="'.$result->id.'" class="radio" name="campaign" value="'.$result->id.'" />
...
';
								...
								<fieldset class="block">
                                    <div id="checkout-register">
                                        ...
                                        <div id="checkout-register-block">
                                            ...
                                            <p>You can unsubscribe or change your preferences at any time. <a href="<?=$site->link?>privacy-policy/">Privacy policy</a>.</p>
                                        </div>
                                    </div>
                                </fieldset>
                            ...
                            <fielset class="block">
								<?php 
                                if (is_array($basket->basket) && count($basket->basket)) {
                                    ...
                                    <div id="payment-controls">
                                        ...
                                        <input type="submit" id="makePayment" name="makePayment" value="Make this payment now" class="submit" />
                                    </div>
                                    <?php
                                }
                                    ...
                                    <div id="payment-controls">
                                        ...
                                        <p><a id="cancel_button" href="/get-involved/">Change this donation before you proceed</a></p>
                                        </div>
                                        <div class="right">
