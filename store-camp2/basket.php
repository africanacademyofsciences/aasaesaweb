                    ...
                    <form action="<?= $request // set at the top of rewrite?>" method="post" id="shopping-basket">
                        ...
                        if( $basket->getGrandTotal()>0 ){ 
                            ...
                            if ($store->config['accept-donation']) { 
                                ?>			
                                <tr>
                                    <td class="gift-aid" colspan="2">
                                        <strong>Add up to 25% to your donation for free. Just complete the Gift Aid Declaration in the checkout.</strong> Gift Aid allows <?=$site->name?> to reclaim tax on donations from UK taxpayers, increasing your generous donation by up to 25%.
                                    </td>
                                </tr>
                                <?php 
                            } 
                            ...
                            <!--
                            THIS IS COLLECTED IN THE CHECKOUT NOW
                            <tr>
                                <td><?=$site->name?> would like to keep you informed of our work tick here if you would like to receive regular updates</td>
                                <td class="col_last"><input type="checkbox" name="news_add_email" value="1" <?=(($_POST['news_add_email']==1)?'checked="checked"':"")?> /></td>
                            </tr>
                            -->
