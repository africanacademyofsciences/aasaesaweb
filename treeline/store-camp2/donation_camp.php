...
if ($action=="create") {
    ...
    <?php
	$page_html = '
	<p><a href="/treeline/store/donation.php">Manage donations</a></p>
    ...
    <fieldset>
		...
		<div class="field">
			<label for="f_amount">&pound; Amount:</label>
	...
	$page_html = '
		<p><a href="/treeline/store/donation.php?action=create">Add another donation</a></p>
...
<script type="text/javascript" src="/treeline/behaviour/tiny_mce/tiny_mce_donation_admin.js"></script>
