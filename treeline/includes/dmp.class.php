...
function BuildDMPXMLDoc($details){
		$dom = new DomDocument();
		...
		$oCustomer->appendChild($dom->createElement("GiftAid",$details["GiftAid"]));
		
		//Direct Debit Name (Mr John Doe)
		$oCustomer->appendChild($dom->createElement("DDName",$details["DDName"]));
		
		//Direct Debit Sort Code 
		$oCustomer->appendChild($dom->createElement("DDSortCode",$details["DDSortCode"]));
		
		//Direct Debit Account Number
		$oCustomer->appendChild($dom->createElement("DDAccountNo",$details["DDAccountNo"]));
		
		//Direct Debit Frequency
		$oCustomer->appendChild($dom->createElement("DDFreq",$details["DDFreq"]));
		
		//Direct Debit Start Date
		$oCustomer->appendChild($dom->createElement("DDStartDate",$details["DDStartDate"]));
...
//	$fp = fsockopen("ssl://".$server, 443); //For SSL
	$fp = fsockopen($server, 80); //For Non-SSL
