...
<?php
	...
	?>
		<script type="text/javascript">var switchTo5x=true;</script>
		<script type="text/javascript" id="st_insights_js" src="https://w.sharethis.com/button/buttons.js?publisher=c8d64428-d271-4d97-8106-7a2458742bea"></script>
...
//print "<!-- menu[".$site->id."] -->\n";
//print "<!-- Show menu for template(".$page->template.") -->\n";
if ($page->template == "report.php") include($_SERVER['DOCUMENT_ROOT'].'/includes/templates/menu-report.inc.php');
else include($_SERVER['DOCUMENT_ROOT'].'/includes/templates/menu.inc.php');
