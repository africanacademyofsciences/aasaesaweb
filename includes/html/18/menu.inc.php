	...
	<div class="container">
		<nav class="navbar navbar-inverse">
			<div class="navbar-header">
				...
				{
				?>
					<a class="navbar-brand" href="<?=$site->link?>"><img src="<?=$site->path?>images/aas-logo.png" alt="African Academy of Sciences"></a>
			...
			<div class="collapse navbar-collapse js-navbar-collapse">
				<ul class="nav navbar-nav">
                    ...
                    foreach ($menu->items as $item) {
                        //print "<!-- Got menu item(".print_r($item, 1).") -->\n";
						...
						//}
						if ($item['title'] == "Programmes" && $site->id == 18)
						{
							$link = $site->link.'programmes/programmes/';
						}
						else if ($item['title'] == "Partners" && $site->id == 18)
						{
							$link = $site->link.'partners/overview/';
						}
						else if ($item['title'] == "Policy & Advocacy" && $site->id == 18)
						{
							$link = $site->link.'policy--advocacy/policy--advocacy/';
						}
						else if ($item['title'] == "Think Tank" && $site->id == 18)
						{
							$link = $site->link.'think-tank/overview/';
						}
						else if ($item['title'] == "Research" && $site->id == 18)
						{
							$link = $site->link.'research/research/';
							...
							$link = "http://aesacop.ac.ke/";
							$linktarget = "_blank";
						}
						else if ($item['title'] == "CARI" && $site->id == 18)
						{
							$link = $site->link.'/cari/coalition-for-african-research-and-innovation/';
						}
						else
						{
							$link = '#';
                        ...
                        <li class="dropdown <?=$item['selected']?>">
                            <a href="<?=$link?>" class="<?=$class?>" <?=$dataToggle?> target="<?=$linktarget?>"><?=$item['title']?></a>
                                        ...
                                        <ul>
                                            ...
                                            <li class="hidden-xs">
                                                <address>
                                                    ...
                                                    -->
                                                    <ul>
                                                        <li><a href="mailto:president@aasciences.org"><i class="ion-ios-email-outline"></i>Email AAS President</a></li>
                                                    </ul>
                                                </address>
                                            </li>
                                        </ul>
                    ...
                    ?>
					<li>
                    	<a href="http://aasciences.ac.ke/">AAS</a>
                    </li>
					<!--
