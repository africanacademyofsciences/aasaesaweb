<?php
	...
	*/
	...
	$pageClass = 'landing-content'; // used for CSS usually
...
<div class="main-content">
	...
	{
		if ($page->guid == '57f646cae0798')
		{
		?>
		<section class="" style="background-color: #EFEFEF !important; padding-bottom: 0px;">
			<div class="container">
				<div class="col-xs-12">
					<div class="col-xs-12" style="background-color: #FFFFFF; box-shadow: 0px 10px 5px -10px rgba(0,0,0,0.75);">
						<h2>Programmes</h2>
						<p><strong>AESA is committed to supporting the development of science, technology and 
						innovation (STI) programmes in Africa. We are focused on supporting the 
						best minds, working in conducive research environments, to design and implement 
						programs that produce quality, relevant data, and innovations that have the potential 
						to impact health and developmental challenges on the continent and globally.</strong></p>
					</div>
				</div>
			</div>
		</section>
		...
		else if ($page->guid == '58456b217be73')
		{
			?>
			<section class="" style="background-color: #EFEFEF !important; padding-bottom: 0px;">
			<div class="container">
				<div class="col-xs-12">
					<div class="col-xs-12" style="background-color: #FFFFFF; box-shadow: 0px 10px 5px -10px rgba(0,0,0,0.75);">
						<h2>Activities and impact</h2>
						<p><strong>AESA is focused on supporting people, places, and programmes, which 
						translates to supporting the best minds in Africa, working in conducive research 
						environments, to implement programmes that produce quality and relevant data, and 
						innovations that have the potential to impact health and developmental 
						challenges on the continent and globally. </strong></p>
					</div>
				</div>
			</div>
		</section>
