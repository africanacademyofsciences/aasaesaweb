...
class Style {
   ...
   * @var Stylesheet
   */
  public $_stylesheet; // stylesheet this style is attached to
   ...
   * @var float
   */
  public $_parent_font_size; // Font size of parent element
